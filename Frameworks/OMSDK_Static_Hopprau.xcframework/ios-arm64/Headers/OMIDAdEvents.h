 ...
 */
@interface OMIDHopprauAdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDHopprauAdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDHopprauVASTProperties *_Nonnull)vastProperties
