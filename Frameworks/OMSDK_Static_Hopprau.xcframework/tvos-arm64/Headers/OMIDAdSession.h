 ...
 */
@interface OMIDHopprauAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDHopprauAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDHopprauAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDHopprauAdSessionContext *)context
