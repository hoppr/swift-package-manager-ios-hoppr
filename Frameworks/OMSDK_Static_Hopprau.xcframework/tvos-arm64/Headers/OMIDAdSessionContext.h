 ...
 */
@interface OMIDHopprauAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDHopprauPartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDHopprauPartner *)partner
                               ...
                               resources:(NSArray<OMIDHopprauVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
